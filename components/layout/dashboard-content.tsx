...
export default function DashboardContent() {
  ...
  const handleAddProductClick = () => {
    // Create and dispatch a custom event to open the Items Dashboard form
    const event = new CustomEvent("openItemsDashboard")
      ...
      <header className="bg-teal-600 text-white shadow-md">
        <div className="container mx-auto px-4 py-4">
          <div className="btn mx-auto">
            ...
            <strong>Inventory Management System - Galenbindunuwewa DS</strong>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
          ...
          <Card className="bg-yellow-100 border-yellow-200 shadow-sm">
            <CardContent className="p-4 text-center flex flex-col items-center justify-center">
              ...
              <Button
                onClick={() => router.push("/items-dashboard")}
                variant="outline"
                className="mt-1 bg-white hover:bg-gray-100"
              >
                Add Product
              </Button>
            </CardContent>
